...
class PenEnvV0(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, reward_type="dense", early_termination=False):
        ...
        self.target_obj_bid = body_name2id(self.model, "target")
        self.S_grasp_sid = site_name2id(self.model, 'S_grasp')
        self.obj_bid = body_name2id(self.model, 'Object')
        self.eps_ball_sid = site_name2id(self.model, 'eps_ball')
        self.obj_t_sid = site_name2id(self.model, 'object_top')
        self.obj_b_sid = site_name2id(self.model, 'object_bottom')
        self.tar_t_sid = site_name2id(self.model, 'target_top')
        self.tar_b_sid = site_name2id(self.model, 'target_bottom')
